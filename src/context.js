...
export const AuthContextProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ isSigned, isLoading, handleLogout, loginProc, userData, error, schoolMap, currScreen, changeScreen }}>
            {children}
